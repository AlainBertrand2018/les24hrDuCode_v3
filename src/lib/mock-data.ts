...
export const MOCK_SPONSORS: Sponsor[] = [
  ...
  { id: 'p1', name: 'Google', tier: 'Platinum', logo_url: '/images/logos/Google_Gemini_logo.png' },
  ...
  { id: 'g1', name: 'Emtel', tier: 'Gold', logo_url: '/images/logos/emtel_logo.png' },
  { id: 'g2', name: 'Mauritius Telecom', tier: 'Gold', logo_url: '/images/logos/mt_logo.png' },
  { id: 'g3', name: 'MauBank', tier: 'Gold', logo_url: '/images/logos/maubank_logo.png' },
