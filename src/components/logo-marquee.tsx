...
const logos = [
    ...
    { id: 'p3', name: 'OpenAI', logo_url: '/images/logos/openai_transp.png' },
    { id: 'p4', name: 'Mistral AI', logo_url: '/images/logos/mistral_transp.png' },
    { id: 'p5', name: 'Anthropic', logo_url: '/images/logos/anthr_transp.png' },
    { id: 'p6', name: 'Vercel', logo_url: '/images/logos/vercel.png' },
    { id: 'g1', name: 'Emtel', logo_url: '/images/logos/emtel_logo.png' },
