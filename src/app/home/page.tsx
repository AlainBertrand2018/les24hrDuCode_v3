...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Select 4 random speakers and mentors only on the client
  ...
  return (
    <>
      ...
      <main className="flex-grow">
        ...
        {/* About Section */}
        <section id="about" className="h-screen flex flex-col justify-center bg-background">
        ...
        <section id="concept-video" className="h-screen flex flex-col justify-center bg-background">
            <div className="container mx-auto px-4 md:px-6">
        ...
        <section id="schedule" className="h-screen flex flex-col justify-center bg-card">
           <div className="container mx-auto px-4 md:px-6">
        ...
        <section id="teams" className="h-screen flex flex-col justify-center bg-background">
          <div className="container mx-auto px-4 md:px-6">
            <div className="space-y-4 mb-12 text-center">
        ...
        <section id="speakers" className="h-screen flex flex-col justify-center bg-card">
           <div className="container mx-auto px-4 md:px-6">
            <div className="space-y-4 mb-16 text-center">
        ...
        <section id="mentors" className="h-screen flex flex-col justify-center bg-background">
           <div className="container mx-auto px-4 md:px-6">
            <div className="space-y-4 mb-16 text-center">
             ...
             <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-8 max-w-6xl mx-auto">
               {featuredMentors.map((mentor) => (
                  <Card 
                      key={mentor.id} 
                      className="group flex flex-col items-center text-center p-6 cursor-pointer transform transition-all duration-300 hover:scale-105 hover:shadow-primary/20 hover:shadow-lg bg-card/50"
                  >
        ...
        {/* Blog Section */}
        <section id="blog" className="h-screen flex flex-col justify-center bg-card">
           <div className="container mx-auto px-4 md:px-6">
            <div className="space-y-4 mb-16 text-center">
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
              {mockArticles.map((article) => (
                <Link key={article.id} href={`/blog/${article.id}`} className="group block">
                  <Card className="overflow-hidden h-full flex flex-col transform transition-all duration-300 hover:scale-105 hover:shadow-primary/20 hover:shadow-lg bg-card/50">
        ...
        <section id="contact" className="h-screen flex flex-col justify-center bg-card">
           <div className="container mx-auto max-w-4xl px-4 md:px-6">
              ...
              <Card className="max-w-xl mx-auto text-left bg-card/80">
